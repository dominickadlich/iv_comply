  ...
  public: {
    Tables: {
      compliance_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "compliance_records_compliance_type_id_fkey"
      ...
      compliance_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "compliance_types_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      notifications_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_log_compliance_record_id_fkey"
